...
DROP ROLE IF EXISTS crm_admin;
DROP ROLE IF EXISTS crm_app;

CREATE ROLE crm_admin WITH LOGIN PASSWORD 'crm_admin' SUPERUSER CREATEDB CREATEROLE;

CREATE ROLE crm_app WITH LOGIN PASSWORD 'crm_app' NOSUPERUSER NOCREATEDB NOCREATEROLE;
